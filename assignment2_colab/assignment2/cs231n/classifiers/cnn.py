...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params["W2"] = np.random.normal(loc=0.0, scale=weight_scale, size=(num_filters*(input_dim[1]/2)*(input_dim[2]/2), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        print(scores.shape)
        scores, afrelu_cache = affine_relu_forward(scores, W2, b2)
        ...
        dx, grads['W3'], grads['b3'] = affine_backward(dl, af_cache)
        loss += 0.5 * self.reg * np.sum(W3 * W3)
        grads['W3'] += self.reg * W3
        dx, grads['W2'], grads['b2'] = affine_relu_backward(dx, afrelu_cache)
